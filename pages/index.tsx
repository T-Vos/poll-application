  ...
  return (
    <div className={styles.fullScreen}>
      <div className={styles.grid}>
        <div className={styles.gridSection}><PollMaker pollQuestions={pollQuestions} onQuestionChange={handleQuestionChange} onAddQuestion={(x: string) => addQuestionToPoll(x)}/></div>
        <div className={styles.gridSection}><Vote pollQuestions={pollQuestions} onVote={x => addVote(x)}/></div>
